...
os.chdir(r'C:\Users\Aman Jha\Documents\GitHub\Scorecard') # making the parent directory as current directory
import csv
...
def scorecard():
	...
	with open(r'pak_inns1.txt','r') as f: # Pakistan Innings
		lines=f.readlines()
	...
	with open(r'india_inns2.txt','r') as f: # India Innings
		lines=f.readlines()
